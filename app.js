...
app.route("/articles")
  ...
  .post(function (req, res) {
    ...
    newArticle.save(function (err) {
      if (!err) {
        res.send("Successfully created the new article kindly check your database.");
      } else {
        res.send(err);
      }
    });
...
/////////////////////Requests Concerning about Specific Articles /////////////////////////////////

app.route("/articles/:articleTitle")

  // req.params.articleTitle  == "Jquery" chain handling of the parameters
